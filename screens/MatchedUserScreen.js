...
import { ScrollView, StyleSheet, View, FlatList, Image, Dimensions, SafeAreaView } from 'react-native';
...
export default class MatchedUserScreen extends Component {
    constructor(props) {
        ...
        const keys = Object.keys(this.user.question_rankings)
        this.state = {
            matchedQuestions: Object.keys(this.user.question_rankings),
            questionRankings: {},
    ...
    renderQuestion = ({ item }) => {
        return (
            <View style={styles.itemContainer}>
                <Image source={checkMarkIcon} style={{ position: "absolute", top: 5, right: 5, zIndex: 5 }} />
    ...
    render() {
        ...
        const numOfCommonQuestions = Object.values(this.state.matchedQuestions).length
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <View style={styles.agreeTextContainer}>
                        <Text style={styles.agreeText}>{`You have alot in common with ${this.user.codename}!`}</Text>
                        <Text style={[styles.agreeText, { marginTop: 10 }]}>{`You agree on ${numOfCommonQuestions}/${TOTAL_NUM_OF_QUESTIONS}!`}</Text>
                    </View>
                    <FlatList
                        numColumns={2}
                ...
                <View style={styles.introduceButtonContainer} >
                    <TouchableOpacity style={styles.button}>
                        <Image source={require("../assets/message.png")} style={{ position: "absolute", left: 10, tintColor: "#fff" }} />
